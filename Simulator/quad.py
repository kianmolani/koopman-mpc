...
class Quad:
    def __init__(self, m, J, l, c, T_max, g, rotor_drag, aero_drag, drag):
        """
        ...
        drag (bool)           :: set to True if you want to include aerodynamic drag as an unmodeled effect

        NOTES & TO-DO:

            (1) Investigate more closely how aerodynamic drag effects are incorporated here. The incorporation has been copied entirely from https://github.com/uzh-rpg/data_driven_mpc/tree/main
            (2) What is 'c_tau'? Also, is 'c' supposed to be motor drag torque? Paper suggests as much
            (3) Paper suggests that 'J' should be a diagonal matrix of the form diag(Jx, Jy, Jz). Though here, it is a vector
    ...
    def update(self, u, h):
        ...
        NOTES & TO-DO:
            ...
            (1) I don't understand the use of unit_quat, nor why we're using it
    ...
    def q_dynamics(self, q, w):
        ...
        NOTES & TO-DO:
            ...
            (1) I don't understand the use of skew_symmetric
    ...
    def v_dynamics(self, q, v):
        ...
        NOTES & TO-DO:
            ...
            (1) I don't understand the use of v_dot_q
            (2) The incorporation of aerodynamic drag effects has been burrowed entirely from https://github.com/uzh-rpg/data_driven_mpc/tree/main
    ...
    def w_dynamics(self, w): 
        ...
        NOTES & TO-DO:
            ...
            (1) It's not obvious that this expression matches what's in https://rpg.ifi.uzh.ch/docs/RAL21_Torrente.pdf
