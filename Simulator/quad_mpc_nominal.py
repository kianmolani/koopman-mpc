""" 
Implementation of Quadrotor MPC class. This class contains properties and functions 
inherent and required by MPC control schemes.
...
from utils.math import quaternion_inverse, skew_symmetric, v_dot_q
...
class QuadMPC:
    def __init__(self, quad: Quad, t_horizon, n_nodes, Q, R):
        ...
        NOTES & TO-DO:
            ...
            (1) Quad and QuadMPC each possess their own states and dynamics methods due to the former being numeric and the latter being symbolic. Work to eliminate this redundancy
            (2) I don't know what 'n_nodes' is supposed to represent
            (3) ETH codebase calls weighing matrices 'q_diagonal' and 'r_diagonal', and denotes these as 'diagonals of Q-/R- matrices'. But they don't seem to be initialized as diagonal matrices
            (4) What is Q_diagonal, and why is diagonalizing Q (if that's what it represents) needed here?
    ...
    def setup_acados_model(self, casadi_model):
        ...
        NOTES & TO-DO:
            ...
            (1) I don't quite understand what 'model.f_impl_expr', 'model.xdot', and 'model.p' are supposed to be
    ...
    def setup_acados_ocp(self, acados_model):
        """
        Builds acados OCP object and OCP solver using acados model. Method burrowed from
        https://github.com/uzh-rpg/data_driven_mpc/tree/main. Please refer to 
        ...
        NOTES & TO-DO:
            ...
            (1) I'm not sure what most of these parameters represent
            (2) Why are lower- and upper-bound constraints defined the way they are?
