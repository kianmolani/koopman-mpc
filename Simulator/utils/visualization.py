...
from utils.math import v_dot_q, quaternion_to_euler, quaternion_inverse, q_dot_q
...
def draw_drone_simulation(art_pack, x_trajectory, quad, targets, targets_reached, sim_traj=None,
    ...
    # Draw drone art
    drone_art = draw_drone(x_trajectory[-1, 0:3], x_trajectory[-1, 3:7], quad.d_x, quad.d_y)
...
# """ 
# Miscellaneous visualization functions. Functions copied from 
...
# from utils.math import q_dot_q, quaternion_inverse, quaternion_to_euler, v_dot_q
...
#     traj          :: full generated reference trajectory. Numpy array of shape nx13
#     u_traj        :: generated reference inputs. Numpy array of shape nx4
#     t             :: timestamps of the references. Numpy array of length n
#     target_points :: m position keypoints used for trajectory generation. Numpy array of shape 3xm
#     target_t      :: timestamps of the reference position keypoints. If not passed, then they are extracted from the t vector, assuming constant time separation
...
#     center :: 3-dimensional array. Center of the ellipsoid
#     covar  :: 3x3 covariance matrix. If the covariance is diagonal, the ellipsoid will have radii equal to the three diagonal axis along axes x, y, z respectively.
#     return :: unknown
